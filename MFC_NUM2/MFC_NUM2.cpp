...
// MFC_NUM2.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CMFCNUM2App, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CMFCNUM2App

CMFCNUM2App::CMFCNUM2App()
{
...
// Единственный объект CMFCNUM2App

CMFCNUM2App theApp;


// Инициализация CMFCNUM2App

BOOL CMFCNUM2App::InitInstance()
{
